...
class TransferBalanceToAnotherUserTest extends TestCase
{
    ...
    {
        $createdAccount1 = factory(Account::class)->create(['id' => 1, 'currency' => 'usd']);
        $createdAccount2 = factory(Account::class)->create(['id' => 2, 'currency' => 'usd']);

        $response = $this->postJson('/api/accounts/'. $createdAccount1->id .'/transactions', [
           'to' => $createdAccount2->id,
           'amount' => 2000,
